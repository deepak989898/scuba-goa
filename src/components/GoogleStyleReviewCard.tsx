...
type Props = {
  ...
  comment: string;
  rating: number;
  /** e.g. "2 weeks ago" — display only, not a Google claim */
  dateLabel?: string;
};
...
/** Google-inspired layout — guest reviews on our site, not imported from Google. */
export function GoogleStyleReviewCard({
  ...
  const initial = (authorName.trim()[0] ?? "G").toUpperCase();
