      ...
      <AnimatePresence>
        {showFab && (
          <motion.button
            ...
            className="fixed bottom-24 left-4 z-[58] flex h-14 w-14 items-center justify-center rounded-full bg-ocean-800 text-white shadow-lg shadow-ocean-900/30 transition hover:bg-ocean-700 md:bottom-8 md:left-8 md:h-16 md:w-16"
