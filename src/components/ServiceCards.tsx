            ...
            return (
              ...
              >
                ...
                <div className="pointer-events-none relative z-[1] flex min-h-0 flex-1 flex-col">
                  {/* 1536×1024 (3:2) — matches card media so image shows full, no crop */}
                  ...
                  <div className="pointer-events-none flex min-h-0 flex-1 flex-col px-1.5 pb-0 pt-1 sm:px-2.5 sm:pt-1.5 [&_*]:pointer-events-none [&_a]:pointer-events-auto">
                    <h3 className="line-clamp-2 bg-gradient-to-r from-cyan-600 via-ocean-700 to-teal-600 bg-clip-text font-display text-xs font-extrabold leading-snug text-transparent sm:text-base">
                      {s.title}
                    </h3>
                  ...
                  <div className="relative z-[2] mt-1.5 flex w-full flex-nowrap items-stretch gap-1 px-1.5 pb-1.5 pointer-events-none sm:mt-2 sm:gap-1.5 sm:px-2.5 sm:pb-2">
                    <span className="pointer-events-auto min-w-0 flex-1 [&_button]:w-full [&_button]:min-h-9 [&_button]:px-1 [&_button]:py-1.5 [&_button]:text-[10px] [&_button]:leading-tight sm:[&_button]:min-h-10 sm:[&_button]:px-3 sm:[&_button]:py-2 sm:[&_button]:text-sm">
                    ...
                    <Link
                      href={`/services/${s.slug}`}
                      className="pointer-events-auto inline-flex min-h-9 min-w-0 flex-1 touch-manipulation items-center justify-center rounded-full bg-cyan-500 px-1 py-1.5 text-center text-[10px] font-extrabold leading-tight text-slate-950 shadow-md shadow-cyan-900/35 transition hover:bg-cyan-400 active:bg-cyan-300 sm:min-h-10 sm:px-3 sm:py-2 sm:text-sm"
                    >
                      Details
                    </Link>
                  </div>
