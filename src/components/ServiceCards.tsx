              ...
              >
                ...
                <div className="relative z-[1] flex min-h-0 flex-1 flex-col pointer-events-none">
                  ...
                  <div className="pointer-events-none flex min-h-0 flex-1 flex-col p-1.5 sm:p-3 [&_*]:pointer-events-none [&_a]:pointer-events-auto">
                    <h3 className="line-clamp-2 min-h-[2.5rem] bg-gradient-to-r from-cyan-600 via-ocean-700 to-teal-600 bg-clip-text font-display text-xs font-extrabold leading-snug text-transparent sm:min-h-[2.5rem] sm:text-base">
                      {s.title}
                    </h3>
