      ...
      <div className="site-container flex items-center justify-between gap-3 py-1.5 sm:py-2">
              ...
              <Link
                ...
                className={
                  overHero
                    ...
                    : active
                      ? "rounded-full bg-slate-800 px-3 py-2 text-sm font-bold text-cyan-300"
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            onClick={() => setOpen((v) => !v)}
          >
            <span className={overHero ? "text-white" : "text-slate-100"}>
              {open ? "✕" : "☰"}
            </span>
          </button>
        </div>
          ...
          <div className="flex flex-col gap-1 px-4 py-3">
            ...
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="inline-flex items-center gap-3 rounded-lg px-3 py-2.5 text-slate-100 hover:bg-slate-800"
                onClick={() => setOpen(false)}
              >
                {item.icon}
            ...
            <a
              ...
              className="inline-flex items-center gap-3 rounded-lg px-3 py-2.5 text-cyan-300 hover:bg-slate-800"
              onClick={() => setOpen(false)}
            >
              {navIcons.whatsapp}
